...
public class TestBeforeMethodInterceptor implements BeforeMethodInterceptor<TestMethodAnnotation> {
    private static Logger log = LoggerFactory.getLogger(TestBeforeMethodInterceptor.class);
