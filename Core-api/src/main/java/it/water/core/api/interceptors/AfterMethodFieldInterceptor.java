...
/**
 * @param <A> Annotation
 *            Used for defining annotation for pre-processing class fields after a method invocation
 * @Author Aristide Cittadino
 */
public interface AfterMethodFieldInterceptor<A extends Annotation> extends AfterMethodInterceptor<A> {
    /**
    ...
    @Override
    default <S extends Service> void interceptMethod(S destination, Method m, Object[] args, Object returnResult, A annotation) {
